...
class ES_Shortcode {
	...
	public static function render_form( $data ) {
		...
		$email_html = '<div class="es-field-wrap"><label><input class="es_required_field es_txt_email" type="email" name="email" value="" placeholder="Email Address" required/></label></div>';
		?>
